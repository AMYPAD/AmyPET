...
def calib_tracer(
    ...
    for a, rvoi in enumerate(rvois):
        ...
        ax2[i,j].text(25, 10, f'$y_{{\mathrm{{SUVr}}}}^{{\mathrm{{NEW}}}} = {m_std:.4f}x_{{\mathrm{{SUVr}}}}^{{\mathrm{{PiB}}}} + {b_std:.4f}$', fontsize=fontsize)
        ax2[i,j].text(25,-10, f'$R^2={r2:.4f}$', fontsize=fontsize)
